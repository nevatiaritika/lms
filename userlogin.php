...
if (isset($_POST ['emailaddress']) && isset($_POST ['password'])) {
    ...
    $pass = $_POST ['password'];
    $query = "Select uid from users where email = '" . $email . "' and active = 1";
    ...
    if ($num != 1) {
        ...
        $query = "Select encrpass from users where email = '" . $email . "'";
    ...
    ================================================== -->
        ...
        <script type="text/javascript">
            function forgotPass()
            {
                ...
                {
                    window.location.href = 'forgotsucc.php?emailforgot=' + emailForgot;
                }
            }
        </script>
